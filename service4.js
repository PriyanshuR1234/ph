...
function getCropRecommendations() {
    ...
    const soilNutrients = document.getElementById('soil-nutrients').value; // New input for soil nutrients
    ...
    if (soilPH < 5.5) {
        ...
        cropRecommendation = "Soil moisture is high.";
    } else {
        cropRecommendation = "Soil conditions are optimal for most crops. You can plant a variety of vegetables, grains, or fruits.";
    }

    // Additional recommendations based on nutrient level
    if (soilNutrients === "poor") {
        cropRecommendation += " You may need to improve soil nutrients with organic fertilizers.";
    } else if (soilNutrients === "rich") {
        cropRecommendation += " Your soil is nutrient-rich. You can grow a wider variety of crops!";
    }
